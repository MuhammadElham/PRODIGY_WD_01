      ...
      <div className="container">
        ...
        >
          ...
          <div className="p-6 sm:p-8">
            ...
            <h1 data-aos="zoom-out" data-aos-duration="800" className="uppercase text-4xl lg:text-7xl font-bold">
              {data.title}
            </h1>
          ...
          <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
            <p data-aos="zoom-out" data-aos-duration="800" className="font-bold text-xl">{data.title2}</p>
